...
namespace deltaTime
{
    ...
    class InputManager
    {
        ...
        /// </summary>
        public InputManager(Player p, LevelManager lm, UIManager ui, CollisionManager col, AnimationManager anim, ParticleManager particle)
        {
            player = p;
            levelManager = lm;
            uiManager = ui;
        ...
        public void ProcessParticles()
        {
            if (KeyPress(Keys.P))
            {
                partManager.AddParticleSystem(new ParticleSystem(new Point(0, 1), 60, new Point(1, 1), 50, EmmisionShape.Line, 1, 1, player.Position.Center, new Point(20, 20), Game1.regularClock));
